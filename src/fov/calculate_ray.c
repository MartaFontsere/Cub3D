...
/*   Updated: 2025/02/26 22:24:42 by mfontser         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void traverse_ray_until_hit(t_ray *ray, t_game *gdata, int *check_ray_x_in_map, int *check_ray_y_in_map)
{
    ...
    while (wall_hit == 0) 
    {
        ...
        if (*check_ray_x_in_map < 0 || *check_ray_x_in_map >= gdata->map.cells_width || *check_ray_y_in_map < 0 || *check_ray_y_in_map >= gdata->map.cells_height) 
