...
#    Updated: 2025/02/03 20:28:31 by mfontser         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES =  cub3D.c initialitations.c pseudoparsing.c print_minimap.c print_player_params.c render.c press_key.c collisions.c movements.c fov.c error.c
