...
/*   Updated: 2025/04/04 00:46:39 by mfontser         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "cub3D_bonus.h"

void	init_ray_direction(t_ray *ray, t_game *gdata, int check_ray_x_map,
		int check_ray_y_map)
{
	ray->dir_x = cos(ray->current_angle);
	ray->dir_y = -sin(ray->current_angle);
	controll_x_limit_case(ray, check_ray_x_map, gdata->player.cell_player_x);
