...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   door_raycasting_utils_bonus.c                      :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mfontser <mfontser@student.42.barcel>      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/26 22:22:08 by mfontser          #+#    #+#             */
/*   Updated: 2025/04/04 00:50:16 by mfontser         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	vertical_coords_convert(t_ray *ray, t_game *gdata)
{
	...
	ray->px_collision_y = gdata->player.y + (ray->diagonal_distance
...
void	horizontal_coords_convert(t_ray *ray, t_game *gdata)
{
	...
	ray->px_collision_x = gdata->player.x + (ray->diagonal_distance
		...
		int check_ray_x_in_map_tmp, int line_crossing)
{
	...
	ray->check_ray_x_map = check_ray_x_in_map_tmp;
		...
		int check_ray_y_in_map_tmp, int line_crossing)
{
	...
	ray->check_ray_y_map = check_ray_y_in_map_tmp;
	ray->line_crossing = line_crossing;
}
