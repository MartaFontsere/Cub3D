...
/*   Updated: 2025/04/03 19:53:35 by mfontser         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		double *target_y)
{
	...
	if (check_collision_x(gdata, gdata->player, *target_x + move_x))
		*target_x += move_x;
	if (check_collision_y(gdata, gdata->player, *target_y + move_y))
		*target_y += move_y;
}
